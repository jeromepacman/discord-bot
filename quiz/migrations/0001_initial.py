    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_points', models.SmallIntegerField(verbose_name='valeur')),
                ('difficulty', models.IntegerField(choices=[(0, 'choisir'), (1, 'Noobs'), (2, 'Medium'), (3, 'Advanced'), (4, 'Hero')], default=0, verbose_name='niveau')),
